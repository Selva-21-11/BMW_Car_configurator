...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        getObjectByName, retrieveObjectNames, Tween,
    };
};
...
animateParam(0, 100, 6, 'Linear', 'InOut', 0, false, '!PcKuYHvBPYb3!Yhv2?+',
    function() {
  setLightParam('INTENSITY', 'Area', _pGlob.animateParamUpdate || 0);
},
    function() {});


bloom(0.8, 0.5, 0.5);
brightnessContrast(0.01, 0.05);

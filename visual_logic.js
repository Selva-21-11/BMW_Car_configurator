...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        getObjectByName, retrieveObjectNames, getMaterialEditableColors, bindListener,
        getElements,
    };
};
...
changeVis('Back spoiler ', false);

eventHTMLElem('click', 'blackcolor', true, function(event) {
  setMaterialColor('Body color red', 'RGB', 0, 0, 0, '');
});
eventHTMLElem('click', 'orangecolor', true, function(event) {
  setMaterialColor('Body color red', 'RGB', 1, 0.088645, 0, '');
});
eventHTMLElem('click', 'bluecolor', true, function(event) {
  setMaterialColor('Body color red', 'RGB', 0, 0.051969, 1, '');
});
eventHTMLElem('click', 'redcolor', true, function(event) {
  setMaterialColor('Body color red', 'RGB', 1, 0.003, 0, '');
});
